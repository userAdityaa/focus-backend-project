  ...
  const handlePost = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        console.log("User Toh hain");
        navigate('/about');
      } else {
        console.log("Error hain mc");
      }
    } catch (error) {
        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-4 md:space-y-6">
                ...
                <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                    Don’t have an account yet? <a href="#" class="font-medium text-primary-600 hover:underline dark:text-primary-500" onClick={handleSignUp}>Sign up</a>
                </p>
            </form>
        </div>
    </div>
